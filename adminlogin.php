...
if (isset($_POST['submit'])) {
    ...
    if (isset($_POST['remember'])) {
        ...
        setcookie('AdminPass', $Password, time() + 86400);
    } else {
        setcookie('AdminEmail', "");
        setcookie('AdminPass', "");
    }

    $query = "select Admin_id from admin_mst where Email='$Email' AND Password='$Password'";
...
<head>
    ...
    <title>TravelBlox | AdminLogin</title>
            ...
            <div class="col-lg-6 col-md-6 contact-left-form mydiv">
                <form action="#" method="post">
                    <div class="form-group contact-forms">
                        <input type="email" class="form-control" placeholder="Email" required="" name="Email" value="<?php if (isset($_COOKIE['AdminEmail'])) {
                            echo $_COOKIE['AdminEmail'];
                        } ?>">
                    </div>
                    <div class="form-group contact-forms password-container">
                        <input type="password" class="form-control" placeholder="Password" required="" name="Password"
                            id="Password" maxlength="10" value="<?php if (isset($_COOKIE['AdminPass'])) {
